...
export default function Politicas() {
    return (
        <>
            <Head>
                <title>Política de privacidade | CT JUNIOR</title>
                <meta name="robots" content="noindex" />
            </Head>
            <main className={Styles.partnersSection}>
                <section className={Styles.whyCtjuniorSection}>
                <h1>Política de privacidade CT Junior</h1>
                <p>
                    A sua privacidade é importante para nós. É política do CT Junior respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site CT Junior, e outros sites que possuímos e operamos.
                    ...
                    <h3>Política de Cookies CT Junior</h3>
                    <p>
                    O que são cookies?
                    ...
                    O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o CT Junior oferece no site e com caráter enunciativo, mas não limitativo:
                    ...
                    C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do CT Junior, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.
